...
if [ -z "${SQUID_CONFIG_S3_BUCKET}" -o -z "${SQUID_CONFIG_S3_PREFIX}" ]; then
  echo "ERROR: SQUID_CONFIG_S3_BUCKET and SQUID_CONFIG_S3_PREFIX environment variables must be provided"
  exit 1
fi

S3_URI="s3://${SQUID_CONFIG_S3_BUCKET}/${SQUID_CONFIG_S3_PREFIX}"
